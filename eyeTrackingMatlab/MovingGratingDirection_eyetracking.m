function [resultsStruct, resultsStruct_batch] = MovingGratingDirection_eyetracking(app)
%analysis for the moving grating direction stimulus for OKR behavior.
...
%% Get moving grating information
...
speed = stimulusInfo.loggedStimuli.speed;
